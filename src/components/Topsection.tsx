          ...
          <div className="col-md-5 col-lg-5 col-xl-5">
            ...
            <div className="uiDiv">
              ...
              <div className="uiDiscription">
                Aliquam lorem ante, dapibus in, viverra. Phasellus viverra nulla
                ut metus varius aenean imperdiet iam odio nunc.
          ...
          <div className="col-md-6 col-lg-6 col-xl-6">
            <div className="uiPropTitle">
              ...
              <div className="uiDiv">
                ...
                <div className="uiDiscription">
                  Quisque eget velit. Duis vitae semper augue. Orci nulla magna,
                  arcu diam inceptos lupus ut quis nibh eu.
                  <div className="readtext">Read More</div>
                </div>
              </div>
            </div>
